    ...
    initContainers: [
      {
        ...
        image:
          'quay.io/openshift-pipeline/tektoncd-pipeline-creds-init:v0.10.1',
      ...
      },
      {
        name: 'place-tools',
        image:
          'quay.io/openshift-pipeline/tektoncd-pipeline-entrypoint:v0.10.1',
    ...
    initContainerStatuses: [
      {
        ...
        state: {
          terminated: {
            ...
            containerID:
              'cri-o://32c22d040609b6b5d728b9830ff7304760091b1aef8a50bd48e7545b957085f8',
          },
        },
        lastState: {},
        ready: true,
      ...
      },
      {
        ...
        state: {
          terminated: {
            ...
            containerID:
              'cri-o://1a547904600598512aa194a06cd3424b326c57b9d6351f9322784c12e9fdbfd1',
          },
        },
        lastState: {},
        ready: true,
    ...
    containerStatuses: [
      {
        ...
        state: {
          terminated: {
            ...
            containerID:
              'cri-o://3d7a65c8cba98f117e6c805c65739462fa3d92a5cc39e7fcb8acb95f9ddc8a04',
          },
        },
        lastState: {},
        ready: false,
