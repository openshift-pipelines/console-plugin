export const pipelineBuilderPO = {
  ...
  formView: {
    ...
    quickSearchListItem(
      ...
      return `[data-test="item-name-${itemName}-${itemType}-${itemProvider}"]`;
    },
    addParams: {
    ...
    addFinallyNode:
      '[data-test="pipeline-builder"] [data-test="add-finally-node"]',
    finallyTaskList:
      '[data-test="builder-finally-node"] [data-test="task-list"]',
  },
  yamlView: {
  ...
  details: {
    ...
    workspacesResources: {
      volumeClaimTemplateResources:
        '[data-test-id="volumeClaimTemplate-resources-section"]',
