            ...
            tasks: [
              {
                ...
                resources: {
                  inputs: [
                    { name: 'optional-input', resource: 'git-resource' },
                  ],
                  outputs: [
                    { name: 'optional-output', resource: 'image-resource' },
                  ],
                },
              },
            ],
            ...
            tasks: [
              {
                ...
                resources: {
                  inputs: [
                    { name: 'required-input', resource: 'git-resource' },
                  ],
                  outputs: [
                    { name: 'required-output', resource: 'image-resource' },
                  ],
                },
              },
            ],
            ...
            tasks: [
              {
                ...
                resources: {
                  inputs: [{ name: 'source-git', resource: 'resource-git' }],
                  outputs: [
                    { name: 'source-image', resource: 'resource-image' },
                  ],
                },
              },
            ],
