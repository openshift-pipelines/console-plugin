...
import { PersistentVolumeClaimKind, PipelineKind } from '../../../types';
...
export const mockRunDurationTest = [
  ...
  pipelineTestData[PipelineExampleNames.WORKSPACE_PIPELINE].pipelineRuns[
    DataState.SUCCESS
  ],
  pipelineTestData[PipelineExampleNames.CLUSTER_PIPELINE].pipelineRuns[
    DataState.SUCCESS
  ],
];
