...
import { HistoryIcon, InfoCircleIcon, MonitoringIcon } from '@patternfly/react-icons';
...
const PipelinesRunsDurationCard: React.FC<PipelinesRunsDurationProps> = ({ summaryData }) => {
  const { t } = useTranslation('plugin__pipeline-console-plugin');

  return (
    <>
      <Card className="pipeline-overview__duration-card">
        <CardTitle>
