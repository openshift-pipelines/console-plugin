...
type PipelineTestData = {
  [key in PipelineExampleNames]?: CombinedPipelineTestData;
};
...
export const pipelineSpec: PipelineSpecData = {
  ...
  [PipelineExampleNames.PARTIAL_PIPELINE]: {
    tasks: [
      ...
      {
        name: 'hello-world-3',
        taskRef: { kind: 'Task', name: 'hello-world-3' },
      },
    ],
  },
  ...
  [PipelineExampleNames.INVALID_PIPELINE_MISSING_TASK]: {
    tasks: [
      { name: 'build-dist', taskRef: { kind: 'Task', name: 'not-a-task' } },
    ],
  },
          ...
          taskRuns: {
            ...
            'react-web-app-cluster-mock-app-pipeline-aaz5bv-compile-f72vg': {
              ...
              status: {
                ...
                podName:
                  'react-web-app-cluster-mock-app-pipeline-aaz5bv-compile-f72vg-pod-333c08',
                startTime: '2019-11-22T15:21:07Z',
                steps: [
                  {
          ...
          conditions: [
            {
              ...
              message:
                'TaskRun broken-app-pipeline-j2nxzm-x-compile-8mq2h has failed',
              reason: 'Failed',
              status: 'False',
              type: 'Succeeded',
            },
          ...
          taskRuns: {
            'broken-app-pipeline-j2nxzm-code-sanity-7mxhc': {
              ...
              status: {
                ...
                podName:
                  'broken-app-pipeline-j2nxzm-code-sanity-7mxhc-pod-qj8vn',
            ...
            'broken-app-pipeline-j2nxzm-install-deps-x5z4w': {
              ...
              status: {
                ...
                podName:
                  'broken-app-pipeline-j2nxzm-install-deps-x5z4w-pod-ff5ng',
                startTime: '2020-07-13T17:21:48Z',
                steps: [
                  {
                    container: 'step-install',
          ...
          taskRuns: {
            'fetch-and-print-recipe-test-fetch-the-recipe-5pb9p': {
              ...
              status: {
                ...
                podName:
                  'fetch-and-print-recipe-test-fetch-the-recipe-5pb9p-pod-ksbnx',
  ...
  [PipelineExampleNames.INVALID_PIPELINE_MISSING_TASK]: {
    ...
    pipelineRuns: {
      [DataState.FAILED1]: {
        ...
        status: {
          pipelineSpec:
            pipelineSpec[PipelineExampleNames.INVALID_PIPELINE_MISSING_TASK],
  ...
  [PipelineExampleNames.INVALID_PIPELINE_INVALID_TASK]: {
    ...
    pipelineRuns: {
      [DataState.FAILED1]: {
        ...
        status: {
          pipelineSpec:
            pipelineSpec[PipelineExampleNames.INVALID_PIPELINE_INVALID_TASK],
          ...
          taskRuns: {
            'fetch-and-print-recipe-sn3peo-fetch-the-recipe-2rjgw': {
              ...
              status: {
                ...
                conditions: [{ status: 'True', type: 'Succeeded' }],
                podName:
                  'fetch-and-print-recipe-sn3peo-fetch-the-recipe-2rjgw-pod-tqk4l',
              },
            },
            'fetch-and-print-recipe-sn3peo-print-the-recipe-cbwbj': {
              ...
              status: {
                ...
                conditions: [{ status: 'True', type: 'Succeeded' }],
                podName:
                  'fetch-and-print-recipe-sn3peo-print-the-recipe-cbwbj-pod-w9724',
              },
            },
          },
        },
          ...
          conditions: [
            {
              ...
              message:
                'Tasks Completed: 1 (Failed: 0, Cancelled 0), Skipped: 1',
              reason: 'Completed',
              status: 'True',
              type: 'Succeeded',
            },
          ...
          taskRuns: {
            'when-expression-pipeline-cx05c9-first-create-file-4sqr2': {
              ...
              status: {
                ...
                podName:
                  'when-expression-pipeline-cx05c9-first-create-file-4sqr2-p-2p5j8',
                startTime: '2021-01-13T14:33:59Z',
              },
            },
          },
    ...
    pipelineRuns: {
      [DataState.IN_PROGRESS]: {
        ...
        status: {
          conditions: [
            {
              ...
              message:
                'Tasks Completed: 1 (Failed: 0, Cancelled 0), Incomplete: 3, Skipped: 0',
              reason: 'Running',
              status: 'Unknown',
              type: 'Succeeded',
            },
          ...
          pipelineSpec:
            pipelineSpec[PipelineExampleNames.EMBEDDED_TASK_SPEC_MOCK_APP],
          ...
          taskRuns: {
            'mock-app-embedded-pipeline-zuazs0-code-sanity-6hpzr': {
              ...
              status: {
                ...
                podName:
                  'mock-app-embedded-pipeline-zuazs0-code-sanity-6hpzr-pod-tgrm2',
            ...
            'mock-app-embedded-pipeline-zuazs0-compile-gtx5z': {
              ...
              status: {
                ...
                podName:
                  'mock-app-embedded-pipeline-zuazs0-compile-gtx5z-pod-hhbgw',
                startTime: '2021-04-23T14:43:50Z',
                steps: [
                  {
                    container: 'step-build',
            ...
            'mock-app-embedded-pipeline-zuazs0-install-deps-75vvh': {
              ...
              status: {
                ...
                podName:
                  'mock-app-embedded-pipeline-zuazs0-install-deps-75vvh-pod-pdldm',
                startTime: '2021-04-23T14:43:30Z',
                steps: [
                  {
                    container: 'step-install',
          ...
          taskRuns: {
            ...
            'mock-app-embedded-pipeline-zuazs0-e2e-tests-7zrkm': {
              ...
              status: {
                ...
                podName:
                  'mock-app-embedded-pipeline-zuazs0-e2e-tests-7zrkm-pod-qcr97',
  ...
  [PipelineExampleNames.PIPELINE_WITH_FINALLY]: {
    ...
    pipelineRuns: {
      [DataState.SUCCESS]: {
        ...
        status: {
          pipelineSpec:
            pipelineSpec[PipelineExampleNames.PIPELINE_WITH_FINALLY],
          completionTime: '2019-10-29T11:57:53Z',
          conditions: [
            {
              lastTransitionTime: '2019-09-12T20:38:01Z',
                ...
                steps: [
                  {
                    ...
                    terminated: {
                      ...
                      message:
                        '[{"key":"sum","value":"12","type":"TaskRunResult"}]',
                      reason: 'Completed',
                ...
                steps: [
                  {
                    ...
                    terminated: {
                      ...
                      message:
                        '[{"key":"sum","value":"22","type":"TaskRunResult"}]',
                      reason: 'Completed',
    ...
    metadata: {
      ...
      annotations: {
        'pipelinesascode.tekton.dev/sha-url':
          'https://www.github.com/dummy/commit/3212345',
      },
      labels: {
        'pipelinesascode.tekton.dev/repository': 'repo1',
...
export const PipeLineRunWithVulnerabilitiesData: Record<
  string,
  PipelineRunKind
> = {
    ...
    metadata: {
      annotations: {
        ...
        'results.tekton.dev/result':
          'jeff-project/results/2e22062d-6a05-4f62-b348-12da06fadbab',
      },
    ...
    spec: {
      pipelineSpec: {
        results: [
          {
            description:
              'The common vulnerabilities and exposures (CVE) result',
            name: 'SCAN_OUTPUT',
  ...
  [PipeLineRunWithVulnerabilitiesNames.MyScanOutput]: {
    ...
    metadata: {
      annotations: {
        ...
        'results.tekton.dev/result':
          'jeff-project/results/8c5a7c3f-3590-40b4-869b-5258d1450726',
      },
