...
class DropDownRowWithTranslation extends React.PureComponent {
  render() {
    ...
    return (
      <li
        role="option"
        className={classNames('pf-v5-c-menu__list-item', className)}
        key={itemKey}
      >
        <a
          href="#"
          ...
          >
            ...
            {active && (
              ...
              <div className="pf-v5-c-menu pf-m-scrollable co-namespace-dropdown__menu">
                <div
                  className="pf-v5-c-menu__content"
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-haspopup="true"
        aria-label={t('plugin__pipelines-console-plugin~Actions')}
      ...
      >
        <span className="pf-v5-c-dropdown__toggle-text">
          {props.title || t('plugin__pipelines-console-plugin~Actions')}
        </span>
        <CaretDownIcon className="pf-c-dropdown__toggle-icon" />
      </button>
...
export const ActionsMenu = ActionsMenu_;
